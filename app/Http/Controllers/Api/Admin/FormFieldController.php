...
class FormFieldController extends Controller
{
    ...
    public function store(Request $request, int $templateId): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'field_type' => 'required|in:text,date,number,resident_number,resident_number_front,resident_number_back,phone,textarea,select,checkbox,radio,consent,signature',
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'field_type' => 'sometimes|required|in:text,date,number,resident_number,resident_number_front,resident_number_back,phone,textarea,select,checkbox,radio,consent,signature',
